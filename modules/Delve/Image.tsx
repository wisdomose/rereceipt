        ...
        >
          <>
            ...
            <div className="flex items-center justify-end flex-nowrap">
              <p className="uppercase mr-1">receipt:</p>
          ...
          <div className="flex justify-between items-center flex-nowrap w-full mb-1">
            ...
            <div className="flex flex-row items-center justify-end">
              <p className="whitespace-nowrap uppercase mr-1">checkin:</p>
            ...
            <div className="flex flex-row items-center">
              <p className="whitespace-nowrap uppercase mr-1">checkout:</p>
              <span style={genStyle(structure.time_out)}>
